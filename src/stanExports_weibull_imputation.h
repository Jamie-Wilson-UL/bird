...
namespace model_weibull_imputation_namespace {
...
public:
  ~model_weibull_imputation() {}
  model_weibull_imputation(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_weibull_imputation_namespace::model_weibull_imputation";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_weibull_imputation";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_weibull_imputation_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      local_scalar_t__ shape = DUMMY_VAR__;
      current_statement__ = 1;
      shape = in__.template read_constrain_lub<local_scalar_t__,
                jacobian__>(1e-12, shape_upper, lp__);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_weibull_imputation_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      log_lik_obs = stan::math::weibull_lpdf<false>(t_obs, shape, scale);
      double log_lik_cens = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 7;
      log_lik_cens = stan::math::weibull_lccdf(t_cens, shape, scale);
      ...
      for (int i = 1; i <= n_obs; ++i) {
        ...
        stan::model::assign(ll_obs,
          stan::math::weibull_lpdf<false>(
            ...
            shape, scale), "assigning variable ll_obs",
      ...
      for (int i = 1; i <= n_cens; ++i) {
        ...
        stan::model::assign(ll_cens,
          stan::math::weibull_lccdf(
            ...
            shape, scale), "assigning variable ll_cens",
          stan::model::index_uni(i));
      }
      ...
      for (int i = 1; i <= n_cens; ++i) {
        ...
        Fc = stan::math::exp(
               stan::math::weibull_lcdf(
                 stan::model::rvalue(t_cens, "t_cens",
                   stan::model::index_uni(i)), shape, scale));
        current_statement__ = 16;
        if (stan::math::logical_lt(Fc, 1e-12)) {
          current_statement__ = 15;
          Fc = 1e-12;
        }
        current_statement__ = 18;
        if (stan::math::logical_gt(Fc, (1 - 1e-12))) {
        ...
        if (stan::math::logical_lt(p, 1e-12)) {
          current_statement__ = 20;
          p = 1e-12;
        }
        current_statement__ = 23;
        if (stan::math::logical_gt(p, (1 - 1e-12))) {
          current_statement__ = 22;
          p = (1 - 1e-12);
        }
        double log1mp = std::numeric_limits<double>::quiet_NaN();
        current_statement__ = 24;
        log1mp = stan::math::log1m(p);
        double log_neglog = std::numeric_limits<double>::quiet_NaN();
        current_statement__ = 25;
        log_neglog = stan::math::log(-log1mp);
        current_statement__ = 26;
        stan::model::assign(t_imputed, (scale *
          stan::math::exp((log_neglog / shape))),
        ...
        if (stan::math::logical_lte(
          ...
          stan::model::assign(t_imputed,
            (stan::model::rvalue(t_cens, "t_cens", stan::model::index_uni(i))
            * (1 + 1e-12)), "assigning variable t_imputed",
            stan::model::index_uni(i));
        }
      }
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      out__.write_free_lub(1e-12, shape_upper, shape);
      local_scalar_t__ scale = DUMMY_VAR__;
      current_statement__ = 2;
      scale = in__.read<local_scalar_t__>();
      out__.write_free_lub(1e-12, scale_upper, scale);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"shape", "scale"};
...
using stan_model = model_weibull_imputation_namespace::model_weibull_imputation;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_weibull_imputation_namespace::profiles__;
}
#endif
#endif
