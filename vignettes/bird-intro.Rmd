---
title: "bird: Bayesian Imputation for Right-censored Data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{bird: Bayesian Imputation for Right-censored Data}
...
plot(fit, type = "completed_dataset_summary", panels = c("hist", "density", "boxplot"))
...
- You can override defaults with `panels = c(...)`.
...
Each completed dataset includes transparency columns (`time`, `imputed_time`, `original_status`, `was_censored`).
Here, `time` is the original observed/censoring time and `imputed_time` is the completed event time.
